  ...
  const entries: TimelineEntry[] = [
    {
      ...
      desc: "Five days, 12 teams, one brief from a real fintech startup. The winning flow shipped to production three weeks later.",
      stats: [
      ...
      photos: [
        {
          ...
          alt: "Summer Design Sprint audience",
        },
        {
    ...
    {
      period: "Apr 2026",
      title: "Portfolio Night Vol. 7",
      desc: "Forty students presented case studies to a panel of hiring managers. Eight walked away with interview callbacks.",
      stats: [
        { label: "Presenters", value: "40" },
        { label: "Callbacks", value: "8" },
      ],
      photos: [
        {
          src: "https://images.unsplash.com/photo-1475721027785-f74eccf877e2?auto=format&fit=crop&w=800&q=80",
          alt: "Presenter on stage at Portfolio Night",
        },
        {
          src: "https://images.unsplash.com/photo-1515187029135-18ee286d815b?auto=format&fit=crop&w=800&q=80",
          alt: "Audience giving critique",
        },
      ],
    },
    {
      ...
      desc: "A full-day online conference on tokens, theming and component APIs, with speakers from four design-tool companies.",
      stats: [
        { label: "Live viewers", value: "2.4k" },
        { label: "Talks", value: "9" },
      ],
      photos: [
        {
          src: "https://images.unsplash.com/photo-1591115765373-5207764f72e7?auto=format&fit=crop&w=800&q=80",
          alt: "Speaker presenting at Design Systems Day",
        },
        {
