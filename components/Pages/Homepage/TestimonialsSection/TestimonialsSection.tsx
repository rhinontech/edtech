  ...
  const testimonials: Testimonial[] = [
    {
      ...
      quote: "The hands-on projects and real-world examples gave me the confidence to tackle complex design challenges. Educore made all the difference in my career pivot.",
      rating: 5,
    ...
    },
    {
      ...
      quote: "Educore transformed the way I think about design systems and auto-layout. I went from feeling stuck to landing my dream role in under 12 weeks.",
      rating: 5,
